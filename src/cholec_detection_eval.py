"""CholecTrack20 detection evaluation helpers.

This script computes the detector table fields used by the CholecTrack20 benchmark:
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Compute CholecTrack20 detector metrics.")
    ...
    parser.add_argument("--output", default="results/logs/yolo11_cholec_detection_metrics")
